...
- **Clarity**: Use descriptive test and step titles that clearly state the intent. Comments should explain why complex or non-obvious test logic is needed, not restate what the test does.
