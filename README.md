...
The repository's [Copilot instructions](.github/copilot-instructions.md) summarize the coding standards. The detailed guidance is in:

- [UI component strategy](.github/instructions/ui.instructions.md) — comment philosophy and reusable component contracts
- [Astro instructions](.github/instructions/astro.instructions.md) — component `Props` documentation
- [Data-layer instructions](.github/instructions/drizzle.instructions.md) — exported-function TSDoc/JSDoc and injectable database parameters

ESLint enforces explicit parameter and return types at exported TypeScript boundaries in `db/` and `src/lib/`.
